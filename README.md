...
The app also includes a **heuristic fallback** — if a model file isn't available, risk is calculated from clinical thresholds for BMI, blood pressure, cholesterol, glucose, and lifestyle factors.
...
- **Hypertension risk module** — separate model with its own dedicated features and scoring
